 ...
 * 行政公告分頁
 */
public class AdminPostFragment extends DrawerFrameworkMainFragment {
    private static final String TAG = "AdminPostFragment";
    ...
    public void loadPageView() {
        ...
        String webSiteStr = webServiceConnection.ResourceServer + "/MobileView/Calendar?access_token=" + prf.getString("access_token", "");
