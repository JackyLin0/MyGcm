...
import tw.com.omnihealthgroup.healthcare.myhealthcommunity.SendGCMFragment;
...
public class MySystemSettingsFragment extends DrawerFrameworkMainFragment {
    private static final String TAG = "MySystemSettingsFragment";
    ...
    private void initView() {
        rootView.findViewById(R.id.profiles_btn).setOnClickListener(new View.OnClickListener() {
            @Override
