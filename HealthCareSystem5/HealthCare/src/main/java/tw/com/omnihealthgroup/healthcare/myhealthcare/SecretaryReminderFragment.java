 ...
 * 秘書叮嚀分頁
 */
public class SecretaryReminderFragment extends DrawerFrameworkMainFragment {
    private static final String TAG = "SecretaryReminderFragment";
    ...
    public void loadPageView() {
        ...
        String webSiteStr = webServiceConnection.ResourceServer + "/MobileView/BloodGlucoseChart?access_token=" + prf.getString("access_token", "");
        pb.show();
