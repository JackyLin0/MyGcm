 ...
 * 營運焦點分頁
 */
public class OperationFocusFragment extends DrawerFrameworkMainFragment {
    private static final String TAG = "OperationFocusFragment";
    ...
    public void loadPageView() {
        ...
        String webSiteStr = webServiceConnection.ResourceServer + "/MobileView/BloodPressureChart?access_token=" + prf.getString("access_token", "");
        pb.show();
