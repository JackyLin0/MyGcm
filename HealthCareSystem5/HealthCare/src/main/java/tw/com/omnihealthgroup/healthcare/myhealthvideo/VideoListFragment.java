 ...
 */
public class VideoListFragment extends DrawerFrameworkMainFragment {
    ...
    protected void onSetToolbar(Toolbar toolbar) {
        ...
        toolbar.setTitle(getString(R.string.fragment_myhealthvideo) + "_網頁播放測試");
    }
    ...
    public void loadPageView() {
        ...
        myBrowser = (WebView) rootView.findViewById(R.id.pageWebView);
        webServiceConnection.setBrowserProperty(myBrowser);
        webServiceConnection.setWebviewProperty(myBrowser, getContext());

        myBrowser.getSettings().setPluginState(WebSettings.PluginState.ON);//撥放YouTube影片

        //        String webSiteStr = "http://th-pp008.24drs.com/MobileView/Calendar?access_token=" + prf.getString("access_token", "");
        String webSiteStr = "file:///android_asset/Video.html";
