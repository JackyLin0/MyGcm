...
public class BloodPressureFragment extends DrawerFrameworkMainFragment {
    ...
    private void initchart() {
        ...
        if (listData.size() > 0) {
            ...
            Log.v(TAG + "recordvalues_BHP", recordvalues_BHP.toString());
            Log.v(TAG + "recordvalues_BLP", recordvalues_BLP.toString());
    ...
    private void drawchart(ArrayList<String> recordtime, ArrayList<String> recordvalues_BHP, ArrayList<String> recordvalues_BLP) {
        ShowMEProgressDiaLog pb = new ShowMEProgressDiaLog(getContext()
                , getString(R.string.webview_loading_title)
                , getString(R.string.msg_tokenget), false, true);
        pb.show();
        ...
        String dataset_label1 = "收縮壓";
        ArrayList<Entry> yVals1 = new ArrayList<>();

        int cont = 0;
        for (int i = 0; i < recordvalues_BHP.size(); i++) {
            if (Integer.parseInt(recordvalues_BHP.get(i)) > 160) {
        ...
        String dataset_label2 = "舒張壓";
        ArrayList<Entry> yVals2 = new ArrayList<>();

        int cont2 = 0;
        for (int i = 0; i < recordvalues_BLP.size(); i++) {
            if (Integer.parseInt(recordvalues_BLP.get(i)) > 160) {
                chart.getAxisLeft().resetAxisMaxValue();
            }
    ...
    private void setleftAxis(LineChart chart) {
        ...
        chart.getAxisLeft().setAxisMaxValue(170f);
    }
