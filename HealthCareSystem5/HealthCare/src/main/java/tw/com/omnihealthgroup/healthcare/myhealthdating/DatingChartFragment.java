...
import tw.com.omnihealthgroup.healthcare.myhealthdating.adapter.DatingViewAdapter;
 ...
 */
public class DatingChartFragment extends DrawerFrameworkMainFragment {
    private static final String TAG = "DatingChartFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_datingchart, container, false);
