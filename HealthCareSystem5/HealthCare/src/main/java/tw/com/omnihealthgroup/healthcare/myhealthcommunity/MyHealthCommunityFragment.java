package tw.com.omnihealthgroup.healthcare.myhealthcommunity;
 ...
 */
public class MyHealthCommunityFragment extends DrawerFrameworkMainFragment {
    private static final String TAG = "MyHealthCommunityFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_myhealthcommunity, container, false);
